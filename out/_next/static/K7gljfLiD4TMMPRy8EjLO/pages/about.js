        ...
        return n(
          ...
          n(
            ...
            n(
              'div',
              { className: 'cf mt5' },
              n('div', { className: ''.concat(r.a.txtH2, ' w-100 fl') }, '\ud83d\udc4b '),
              n(
                'div',
                { className: 'f4 w-80-ns w-100 lh-copy mt3' },
                'Maya Gao is a Product Designer based in San Francisco.',
              ),
              n(
                'div',
                { className: 'f5 w-70-ns w-100 lh-copy mt3' },
                ...
                n(
                  'a',
                  {
                    ...
                    href:
                      'https://observablehq.com/@observablehq/changelog-2019-08-29?collection=@observablehq/changelog',
                  },
                  'collaborative',
                ),
                ' ',
                'data science tools at Observable. Previously Maya helped build code editors for fast prototyping at',
                ' ',
                n('a', { className: 'link blue hover-dark-blue', href: 'https://stripe.com/' }, 'Stripe'),
                ', and mapping software for GIS professionals at',
                ' ',
                n('a', { className: 'link blue hover-dark-blue', href: 'https://mapbox.com/' }, 'Mapbox'),
                '. She strives to create simple practical solutions for complicated problems.',
              ),
              n(
                'div',
                { className: 'mt5' },
                n(
                  'a',
                  { className: 'mr2 o-40 link glow', href: 'https://github.com/mayagao', title: 'GitHub' },
                  n(
                    'svg',
                    {
                ...
                n(
                  'a',
                  { className: 'mr2 o-40 link glow', href: 'https://twitter.com/mayaqgao', title: 'Twitter' },
                  n(
                    'svg',
                    {
                      style: { width: '22px', height: '22px' },
                ...
                n(
                  'a',
                  { className: 'mr2 o-40 link glow', href: 'https://www.linkedin.com/in/mayagq', title: 'LinkedIn' },
                  n(
                    'svg',
                    {
                      style: { width: '22px', height: '22px' },
                ...
                n(
                  'a',
                  { className: 'mr2 o-40 link glow', href: 'https://dribbble.com/mayagao', title: 'Dribbble' },
                  n(
                    'svg',
                    {
                      style: { width: '22px', height: '22px' },
