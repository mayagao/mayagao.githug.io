...
const projects = [
  {
    ...
    image: (
      <div className="mt4-ns mt2 ph4-ns ph0 nb4-ns nb0">
        <img style={{ width: '644px' }} className="br3 " src="static/img/home-rk.png" />
      </div>
    ),
              ...
              <div className="w-100 mt5 flex-l flex-none mb3">
                ...
                <div style={{ flex: '1 1 30%' }} className="lh-copy mt3 mt0-l flex f7 pl4-l pl0">
                  <div className="self-end">
                    ...
                    <div className={`${styles.txtBody} black`}>{p.description}</div>

                    <div className="mt2 db blue f5">
                      {' '}
                      Learn more <img className="v-top child mt1 h1 " src="../static/icons/next.svg" />
                    </div>
                  </div>
                </div>
              </div>
