...
const sideProjects = [
  {
    ...
    description: "Explanations for some complicated CSS properties.",
    link: "https://mayagao.github.io/css-quick-reference/"
  },

  {
    title: "Accessible Code Theme",
    description: "Design custom CodeMirror themes and test contrast ratio.",
    link: "https://mayagao.github.io/accessible-code-theme/"
  }
];
export default () => (
  <Page>
    <div className={`${styles.limiter}`}>
      ...
      <div className="cf mt5">
        ...
        <div className="mt5">
          <a
            className="mr2 o-40 link glow"
            href="https://github.com/mayagao"
            title="GitHub"
          >
            <svg
