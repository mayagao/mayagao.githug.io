...
const functionDetails = [
  ...
  },
  {
    ...
    description: `Deciding whether to build something is always hard. Prototyping helped us discover some accuracy intricacies with this interaction. So we didn't move forward with it.`
  },
  {
...
<Page>
  ...
  <div className={`${styles.limiter} ${styles.columnContainer}`}>
    <div className={`${styles.leftColumn}`}>
      <a href="" className="db mb4 relative link light-silver hover-moon-gray">
        <div>
      ...
      <div className={`${styles.txtBody} mb5`}>
        ...
        A main focus of the release was the style editor,
        a professional map design tool. With Studio users can select a map layer,
        edit data sources of the layer, and then define certain styling properties such as font-size and opacity.
      ...
      <div className={`${styles.txtBody}`}>
        Before Mapbox Studio style editor,
        there wasn't really a digital map design tool availalbe that provide complete design control for things like texture, color and fonts.
        Retaining flexibility that comes with all those poweful customization options,
        providing visibility for the important features,
...
<div className="bg-near-white pv3 lh-copy">
  ...
  <div className={`${styles.limiter}`}>
    <div className={`${styles.columnContainer}`}>
      <div className={`${styles.leftColumn}`}>
        ...
        <div className={`${styles.txtBody}`}>Property functions provides allows for adjusting values at different <b>zoom stops</b>. There are a few complexities that comes with the property function: </div>
        <ol className={`${styles.txtBody} pv3 mb-list`}>
    ...
    <div className="w-100 mt5 flex-l flex-none br2 mb3">
      ...
      <div  style={{flex: '1 1 240px'}} className="lh-copy flex f7 pl4-l pl0">
        <div className="self-end mb4-l">
          ...
          <div className={`${styles.txtSbody} mt2`}>The goal of the home page is to help user navigate and find what they are looking for. We identified three most common tasks: design, develop and data visualization and made them easy accessible from the main view. </div>
        </div>
      </div>
    </div>
    <div className="w-100 mt4 flex-l flex-none br2 mb4">
      ...
      <div style={{flex: `1 1 240px`}} className="lh-copy flex pl4-l pl0">
        <div className="self-end f7 mb4-l">
          ...
          <div className={`${styles.txtSbody} mt2`}>The listing pages consist of a left main view with all styles/tilesets in a user's account, and a right sidebar explaining how to use those resources. There is also a data upload popover showing the status of current upload. </div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="w-100 bg-near-white pv4 lh-copy">
    <div className={`${styles.limiter}`}>
      <div className={`${styles.txtH2}`}>Modal</div>
      <div className={`${styles.txtBody} mb4`}>Modal is another main UI component. The challenge here is explaining abstract concepts and displaying large amount of information in a very confined space.</div>
      <div className="flex-l flex-none">
        ...
        <div style={{flex: `1 1 397px`}}  className="ml4-l ml0">
          ...
          <div  className={`${styles.txtSbody} mw6`}>Composite means combining various data sources for use cases like label collision detection. Here I tried to use illustration to explain a abstract concept. </div>
        </div>
    ...
    <div className={`${styles.columnContainer} pb3 cf`}>
      <div className={`${styles.leftColumn}`}>
        ...
        <div className={`${styles.txtBody} mb3`}>
         ...
         <div className={`${styles.txtBody}`}>
          Using the same tool to design and develop and communicate really helps build empathy between designers and engineers. In a small team and a highly iterative environment, opening a pull request also brings more credibility to the design decisions than ../static images. It allows me to establish trust and introduce systematic changes merely a few months before the launch. </div>
      </div>
    </div>
