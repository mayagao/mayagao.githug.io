...
export default () => (
  <Head>
    ...
    <meta
      name="description"
      content="👋 Hi, I am a product designer living and working in Washington D.C. I enjoy working on tools that can enable and empower people to create new things. Currently I help build software for developers and designers at Mapbox."
    />
