...
`}</style>
        ...
        <div className='items-center h-full mt5 absolute absolute--fill flex'>
          <a onClick={this.onClickPrev} className='br-100 left-0 nl5 absolute  shadow shadow-1-on-hover pointer fl dib-l dn bg-white h2 items-center flex-l ph2'>
            <img className='h1 w1 o-50 glow ' src='../../static/icons/prev.svg' />
          </a>
          <a onClick={this.onClickNext} className='br-100 right-0 nr5 absolute shadow shadow-1-on-hover pointer fr dib-l dn bg-white h2 items-center flex-l ph2'>
