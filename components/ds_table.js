...
export default class DsTable extends React.Component {
  render () {
    ...
    return (
      <div>
        {content.map((ft,i) => (
          <div key={i} className='flex lh-copy bt b--black-10 pt4 items-end-m content-stretch items-start items-start-l f6 flex-row-ns flex-column mt4'>
            ...
            <div className='flex w5-l w4 tc flex-column'>
              {ft.image}
            </div>
          </div>
        ))}
