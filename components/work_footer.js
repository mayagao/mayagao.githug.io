...
export default () => (
  <div className=" bg-near-white center mb0 bb bw2 pb5 pt5 black ">
    <div className="mw-limiter center cf ph6-l ph4 ">
      ...
      <p className=" o-60">
         Maya is a product designer living and working in Washington D.C. Currently I design and build things at Mapbox. Previously at Lonely Planet, Upstatement.</p>
